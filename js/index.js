...
function ready() {
  ...
  document.querySelector('#cart_checkout')[0].addEventListener('click', purchaseClicked);
}
...
function addItemToCart(title, price, imageSrc) {
  ...
  cart.appendChild(ul);
  cart.querySelector('#cart_trash')[0].addEventListener('click', removeCartItem);
  cart.querySelector('#cart_quantity')[0].addEventListener('change', quantityChanged)
}
